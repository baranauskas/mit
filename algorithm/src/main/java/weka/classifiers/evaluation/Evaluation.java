 ...
 * <p/>
 *
 * Example usage from within an application: <code>
 * <pre>
...
public class Evaluation implements Summarizable, RevisionHandler, Serializable {
     ...
     * @throws Exception if cost matrix is not compatible with data, the class
     * is not defined or the class is numeric
     * @see #useNoPriors()
     * @see #setPriors(Instances)
     */
     ...
     * default is to display all built in metrics and plugin metrics that
     * haven't been globally disabled.
     *
    ...
    /**
     * Get a list of the names of metrics to have appear in the output The
     * default is to display all built in metrics and plugin metrics that
     * haven't been globally disabled.
     *
     ...
     * AbstractEvaluationMetric.getName()) or the fully qualified class name of
     * the metric to find
     ...
     * predictions that have been collected in the
     * evaluateClassifier(Classifier, Instances) method. Returns
     * Utils.missingValue() if the area is not available.
     *
     * @param classIndex the index of the class to consider as "positive"
    ...
    /**
     * Performs a (stratified if class is nominal) cross-validation for a
     * classifier on a set of instances. Performs a deep copy of the classifier
     * before each call to buildClassifier() (just in case the classifier is not
     ...
     * @param numFolds the number of folds for the cross-validation
     * @param random random number generator for randomization
     * @param forPrinting varargs parameter that, if supplied, is expected to
     * hold a weka.classifiers.evaluation.output.prediction.AbstractOutput
     ...
     *
     * @param args an array of command line arguments, the first of which must
     * be the class name of a classifier.
     */
    public static void main(String[] args) {
     ...
     * @param storePredictions whether to store predictions for nominal
     * classifier
     ...
     * @throws Exception if model could not be evaluated successfully or the
     * data contains string attributes
     */
     ...
     * have been collected. This should be null if no predictions have been
     * collected.
     */
    ...
    /**
     * Return the Kononenko & Bratko Relative Information score. Differs
     * slightly from the expression used in KB's paper because it uses the mean
     * log-loss of the TEST instances wrt to the null model for normalization.
     *
    ...
    /**
     * Returns the mean difference in base-2 log loss between null model and
     * scheme.
     *
     ...
     * @param globalInfo include the global information string for the
     ...
     * buffer of stored values. Also updates minimum and maximum target value.
     *
    ...
    public String getRevision() {
        return RevisionUtils.extract("$Revision: 14756 $");
    }
}
